...
<body>
    ...
    <main>
        <input type="hidden" id="status" value="<%= request.getAttribute("gett") %>">
        <div class="requirementPage">
            <form action="SubmitRequirementBuyerServlet" method="post">
                ...
                <div class="quantityAndRate">
                    <div class="quantity">
                        ...
                        <div class="inputQuantity">
                            ...
                            <select name="quantity-ex" id="quantity-ex" required>
                    ...
                    <div class="rate">
                        ...
                        <div class="inputRate">
                            ...
                            <select name="rate-ex" id="rate-ex" required>
                                <option value="/ kg">/ kg</option>
